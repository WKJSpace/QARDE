#include "qarde_fbems.hpp"
#include <hls_stream.h>

static void read_intrinsic_llr_fbems(
...
static void write_decisions_fbems(
...
// Clang-format off
    ...
    read_intrinsic_llr_fbems(intrinsic_LLR, L_buf);
    ...
    write_decisions_fbems(x_hat_buf, synd_buf, decide, synd);
}
